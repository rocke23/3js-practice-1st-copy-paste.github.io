    ...
    FlipClock.DailyCounterFace = FlipClock.Face.extend({
      ...
      build: function (b) {
        ...
        (b = b ? b : this.factory.time.getDayCounter(this.showSeconds)),
          ...
          this.showSeconds
            ? a(this.createDivider(stm_flipclocks_labels.seconds)).insertBefore(
                this.lists[this.lists.length - 2].$el
              )
            : (e = 2),
          a(this.createDivider(stm_flipclocks_labels.minutes)).insertBefore(
            this.lists[this.lists.length - 4 + e].$el
          ),
          a(this.createDivider(stm_flipclocks_labels.hours)).insertBefore(
            this.lists[this.lists.length - 6 + e].$el
          ),
          a(this.createDivider(stm_flipclocks_labels.days, !0)).insertBefore(
            this.lists[0].$el
          ),
          this.base();
      },
